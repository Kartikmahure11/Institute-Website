    ...
    $(".bt_contact_form div").hasClass("bt_contact_form_div") &&
      ...
      e("input[name='trending']").change(function (t) {
        ...
        if (
          ...
          e(".spcial").attr(
            "href",
            "https://www.besanttechnologies.com/payment-online/?e=" + o
          ),
      ...
      e(
        ...
        e("body, html").animate({ scrollTop: a }, 900);
      }),
      ...
      e(".showmore").showMore({
        ...
        hideText: 'Show More <i class="bx bx-down-arrow-alt" aria-hidden="true"></i>',
      }),
          ...
          e(this)
            ...
            .each(function () {
              ...
              if (t) {
                ...
                e(".npkh").attr(
                  "href",
                  "https://www.besanttechnologies.com/payment-online/?e=" + s
                );
